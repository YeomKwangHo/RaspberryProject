...
public class Person_Dialog extends Dialog {
    ...
    private View.OnClickListener mLeftClickListener = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            mpersonData = new Person_Data();
            mpersonData.setPerson(Edit_Person_name.getText().toString(), Integer.parseInt(Edit_Person_age.getText().toString()), RBtn_Male.isChecked() ? true : false);
            mmainActivity.SendDataToServer(mpersonData);
            dismiss();
        }
    };
